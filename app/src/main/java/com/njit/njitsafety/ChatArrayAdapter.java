...
/**
 * Created by Anuradha on 04-04-2017.
 */
...
/**
 * Created by Anuradha on 31-03-2017.
 */
...
public class ChatArrayAdapter extends ArrayAdapter<ChatMessage>{
    ...
    public View getView(int position,View ConvertView, ViewGroup parent){
        ...
        chatText.setBackgroundResource(messageobj.left ? R.drawable.r_rect_s :R.drawable.r_rect_r);
